...
def _load_module(script_file: str) -> importlib.machinery.ModuleSpec:
    """
    Load a Python module dynamically from the specified script file.

    Parameters
    ----------
    script_file : str
        The name of the script file to load (relative to the 'scripts/autoreduction' directory).
    ...
    script_path = _root_dir / "scripts" / "autoreduction" / script_file
...
reduce_EQSANS = _load_module("reduce_EQSANS.py")
