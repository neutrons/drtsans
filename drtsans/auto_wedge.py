...
def getWedgeSelection(data2d, q_min, q_delta, q_max, azimuthal_delta, peak_width=0.25, background_width=1.5,
    ...
    print(f'[DEBUG] min_vec 0: center = {center_vec[0]}, span = {peak_width * fwhm_vec[0]} --> '
          f'{center_vec[0] - peak_width * fwhm_vec[0]}')
    print(f'[DEBUG] max_vec 0: center = {center_vec[0]}, span = {peak_width * fwhm_vec[0]} --> '
          f'{center_vec[0] + peak_width * fwhm_vec[0]}')

    print(f'[DEBUG] min_vec 1: center = {center_vec[0]}, span = {background_width * fwhm_vec[0]} --> '
          f'{center_vec[0] + background_width * fwhm_vec[0]}')
    print(f'[DEBUG] max_vec 1: center = {center_vec[1]}, span = {background_width * fwhm_vec[1]} --> '
          f'{center_vec[1] - background_width * fwhm_vec[1]}')

    print(f'[DEBUG] min_vec 2: center = {center_vec[1]}, span = {peak_width * fwhm_vec[1]} --> '
          f'{center_vec[1] - peak_width * fwhm_vec[1]}')
    print(f'[DEBUG] max_vec 2: center = {center_vec[1]}, span = {peak_width * fwhm_vec[1]} --> '
          f'{center_vec[1] + peak_width * fwhm_vec[1]}')

    print(f'[DEBUG] min_vec 3: center = {center_vec[1]}, span = {background_width * fwhm_vec[1]} --> '
          f'{center_vec[1] + background_width * fwhm_vec[1]}')
    print(f'[DEBUG] max_vec 3: center = {center_vec[0]}, span = {background_width * fwhm_vec[0]} --> '
          f'{center_vec[0] - background_width * fwhm_vec[0]}')
