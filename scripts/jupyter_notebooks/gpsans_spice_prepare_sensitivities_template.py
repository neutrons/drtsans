...
from drtsans.mono.gpsans.prepare_sensitivities_correction import prepare_spice_sensitivities_correction
...
# Correction
prepare_spice_sensitivities_correction(flood_spice_runs, transmission_spice_runs,
                                       MOVING_DETECTORS, MIN_THRESHOLD, MAX_THRESHOLD,
                                       NEXUS_DIR, UNIVERSAL_MASK, MASKED_PIXELS,
