...
from drtsans.iq import determine_1d_linear_bins, determine_1d_log_bins_new, BinningMethod, bin_intensity_into_q1d
...
def test_1d_bin_log_no_wt():
    ...
    # Verify bin edges and bin center
    log_bins = determine_1d_log_bins_new(q_min, q_max, decade_on_center=False,
