...
def test_convert_to_q_eqsans(workspace_with_instrument):
    ...
    assert ws.x(0) == approx([2.95, 3.05, 3.15, 3.25], abs=1e-8)
    assert ws.y(0) == approx([72, 30, 59], abs=1e-8)
    assert ws.y(1) == approx([98, 97, 36], abs=1e-8)
    assert ws.y(5) == approx([97, 41, 40], abs=1e-8)
    assert ws.e(0) == approx(np.sqrt(np.array([72, 30, 59])), abs=1e-8)
    assert ws.e(1) == approx(np.sqrt(np.array([98, 97, 36])), abs=1e-8)
    assert ws.e(5) == approx(np.sqrt(np.array([97, 41, 40])), abs=1e-8)
