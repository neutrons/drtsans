...
def data_test_16b():
    ...
    """
    return dict(profiles=[IQmod([3.1622777e+01, 2.7950850e+00, 6.7620100e-01, 2.4705300e-01, 1.1313700e-01,
                                 5.9768000e-02, 3.4846000e-02, 2.1837000e-02, 1.4459000e-02, 1.0000000e-02,
                                 7.1640000e-03, 5.2830000e-03, 3.9920000e-03, 3.0800000e-03, 2.4190000e-03],
                                [3.16228e-01, 2.79510e-02, 6.76200e-03, 2.47100e-03, 1.13100e-03, 5.98000e-04,
                                 3.48000e-04, 2.18000e-04, 1.45000e-04, 1.00000e-04, 7.20000e-05, 5.30000e-05,
                                 4.00000e-05, 3.10000e-05, 2.40000e-05],
                                ...
                                [1.0e-05, 2.0e-05, 3.0e-05, 4.0e-05, 5.0e-05, 6.0e-05, 7.0e-05, 8.0e-05, 9.0e-05,
                                 1.0e-04, 1.1e-04, 1.2e-04, 1.3e-04, 1.4e-04, 1.5e-04]),
                          IQmod([1.073269, 0.651967, 0.421468, 0.285972, 0.201697, 0.146838, 0.109761, 0.0839,
                                 0.065374, 0.051791, 0.041631, 0.033897, 0.027915, 0.023225, 0.019502],
                                [0.010733, 0.00652, 0.004215, 0.00286 , 0.002017, 0.001468, 0.001098, 0.000839,
                                 0.000654, 0.000518, 0.000416, 0.000339, 0.000279, 0.000232, 0.000195],
                                [0.0098, 0.0113, 0.0128, 0.0143, 0.0158, 0.0173, 0.0188, 0.0203, 0.0218, 0.0233,
                                 0.0248, 0.0263, 0.0278, 0.0293, 0.0308],
                                [9.80e-05, 1.13e-04, 1.28e-04, 1.43e-04, 1.58e-04, 1.73e-04, 1.88e-04, 2.03e-04,
                                 2.18e-04, 2.33e-04, 2.48e-04, 2.63e-04, 2.78e-04, 2.93e-04, 3.08e-04]),
                          IQmod([4.601934, 3.481434, 2.68861, 2.113573, 1.687456, 1.365714, 1.118729, 0.926323,
                                 0.774452, 0.65315, 0.55522, 0.475386, 0.409725, 0.355278, 0.30979],
                                [0.046019, 0.034814, 0.026886, 0.021136, 0.016875, 0.013657, 0.011187, 0.009263,
                                 0.007745, 0.006531, 0.005552, 0.004754, 0.004097, 0.003553, 0.003098],
                                [0.0241, 0.0261, 0.0281, 0.0301, 0.0321, 0.0341, 0.0361, 0.0381, 0.0401, 0.0421,
                ...
                target=0,  # which profile of the previous list is the one to which we must rescale all others
                ...
                stitched=IQmod([3.16227766e+01, 2.79508497e+00, 6.76200688e-01, 2.47052942e-01,
                               ...
                               [0.001, 0.002, 0.003, 0.004, 0.005, 0.006, 0.007, 0.008, 0.009, 0.01, 0.011, 0.0113,
                                ...
                                0.0421, 0.0441, 0.0461, 0.0481, 0.0501, 0.0521],
                               [1.00e-05, 2.00e-05, 3.00e-05, 4.00e-05, 5.00e-05, 6.00e-05, 7.00e-05, 8.00e-05,
                                9.00e-05, 1.00e-04, 1.10e-04, 1.13e-04, 1.20e-04, 1.28e-04, 1.30e-04, 1.43e-04,
