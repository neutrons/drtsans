...
def show_calibration_stage0(barscan_dataset, calibration, pt_numbers):
    # Report calibration
...
def show_calibration_stage1(flood_ws_name, database_file):
    ...
    plot_workspace(flood_ws_name, axes_mode='xy', prefix='step1_')
    plot_workspace(calibrated_flood_ws_name, axes_mode='xy', prefix='step1_')
    apply_calibrations(flood_ws_name, output_workspace=calibrated_flood_ws_name,
...
calibration_returns = generate_spice_pixel_map(ipts, exp_number, scan_number, pt_number_list,
...
for index, returned in enumerate(calibration_returns):
    if index == 0:
        ...
        show_calibration_stage0(bar_scan_dataset, calibration_stage0, pt_number_list)
