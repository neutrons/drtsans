...
from mantid.simpleapi import CompareWorkspaces, ExtractMask, Load, LoadEventNexus
...
def test_reduction(reference_dir):
    ...
    try:
        ...
        ws601m, masked60_detectors1m = ExtractMask(
            mask60_ws1m, OutputWorkspace="__edited_mask601m"
        )
        ...
        hfir_cli.SensitivityCorrection(
            pjn(shared_dir, sensitivity_file),
            min_sensitivity=0.5,
            max_sensitivity=1.5,
            use_sample_dc=True,
        )
