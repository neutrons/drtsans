...
def show_calibration_stage1(raw_flood_ws_name, database_file):
    ...
    apply_calibrations(raw_flood_ws_name, output_workspace=calibrated_flood_ws_name,
...
calibration_returns = generate_spice_pixel_map(ipts, exp_number, scan_number, pt_number_list,
                                               ...
                                               root_dir, root_save_dir, mask_file)
...
for index, returned in enumerate(calibration_returns):
    if index == 0:
        ...
        demo_flood_raw_ws = show_calibration_stage0(bar_scan_dataset, calibration_stage0, pt_number_list,
                                                    flood_nexus, calib_db_file)
