...
def test_wedge():
    intensities = r"""1.5	1.9	2.2	1.8	1.9	2.8	2.2	2.9	2.2	2.2	1.5
    ...
    errors = r"""0.7	0.4	0.6	0.5	0.5	0.7	0.6	0.7	0.5	0.4	0.75
    ...
    intensities = np.array([float(i) for i in intensities.replace('\n', '\t').split('\t')]).reshape((11, 11))
    errors = np.array([float(i) for i in errors.replace('\n', '\t').split('\t')]).reshape((11, 11))
